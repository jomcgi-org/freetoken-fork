...
class OffloadMoeCache:
    ...
    def set_bank_sources(
        ...
        Non-pinned layers have no direct device address. LOCKED/PAGEABLE layers must
        route to the CPU executor; DISK layers may instead use ``moe_disk_decode=gpufetch``
        and pass through a pinned staging ring. The direct copy plan skips all of them,
        and prefill overlap remains incompatible with split residency.
        """
